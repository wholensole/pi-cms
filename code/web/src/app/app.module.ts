...
@NgModule({
  declarations: [
    ...
    ChatFixedWidget,
    AdminMediaWidget,
    AdminProductVideoWidget,
    AdminPdfWidget,
    PageNotFoundTemplate,
    AdminDashboardTemplate,
    AdminPageNotFoundTemplate,
    AdminUsersTemplate,
    AdminUserTemplate,
    AdminMediaTemplate,
    AdminChatbotTemplate,
    AdminSeoTemplate,
    AdminPostsTemplate,
    ...
    AdminSidebarWidget,
    PageContactTemplate,
    PageAskAnExpertTemplate,
    PageEmailCaptureTemplate,
    PageNewsletterRequestTemplate,
    PagePressReleasesTemplate,
    PageRmaFormTemplate,
    PageTrainingRequestTemplate,
    PageBlogTemplate,
    PageCaseStudiesTemplate,
    AdminSitemapTemplate
  ],
  imports: [
